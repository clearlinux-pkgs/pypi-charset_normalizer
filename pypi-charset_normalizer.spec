...
Source0  : https://files.pythonhosted.org/packages/ff/d7/8d757f8bd45be079d76309248845a04f09619a7b17d6dfc8c9ff6433cac2/charset-normalizer-3.1.0.tar.gz
...
%prep
%setup -q -n charset-normalizer-3.1.0
cd %{_builddir}/charset-normalizer-3.1.0
pushd ..
cp -a charset-normalizer-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678118085
