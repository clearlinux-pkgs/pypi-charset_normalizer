...
Source0  : https://files.pythonhosted.org/packages/56/31/7bcaf657fafb3c6db8c787a865434290b726653c912085fbd371e9b92e1c/charset-normalizer-2.0.12.tar.gz
...
%prep
%setup -q -n charset-normalizer-2.0.12
cd %{_builddir}/charset-normalizer-2.0.12
pushd ..
cp -a charset-normalizer-2.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653008805
...
cp %{_builddir}/charset-normalizer-2.0.12/LICENSE %{buildroot}/usr/share/package-licenses/pypi-charset_normalizer/753eb879a99db2b65e384b3c1baec552b6134f26
