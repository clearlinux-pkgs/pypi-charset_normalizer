...
Source0  : https://files.pythonhosted.org/packages/cf/ac/e89b2f2f75f51e9859979b56d2ec162f7f893221975d244d8d5277aa9489/charset-normalizer-3.3.0.tar.gz
...
%prep
%setup -q -n charset-normalizer-3.3.0
cd %{_builddir}/charset-normalizer-3.3.0
pushd ..
cp -a charset-normalizer-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696259272
