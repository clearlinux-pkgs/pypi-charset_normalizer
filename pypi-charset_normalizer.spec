...
Source0  : https://files.pythonhosted.org/packages/2a/53/cf0a48de1bdcf6ff6e1c9a023f5f523dfe303e4024f216feac64b6eb7f67/charset-normalizer-3.2.0.tar.gz
...
%prep
%setup -q -n charset-normalizer-3.2.0
cd %{_builddir}/charset-normalizer-3.2.0
pushd ..
cp -a charset-normalizer-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689001604
