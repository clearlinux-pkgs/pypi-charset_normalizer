...
Source0  : https://files.pythonhosted.org/packages/a1/34/44964211e5410b051e4b8d2869c470ae8a68ae274953b1c7de6d98bbcf94/charset-normalizer-2.1.1.tar.gz
...
%prep
%setup -q -n charset-normalizer-2.1.1
cd %{_builddir}/charset-normalizer-2.1.1
pushd ..
cp -a charset-normalizer-2.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661192329
